...
public class ConnectedIdController extends JsonUtil {
    ...
    public ResponseEntity<String> initConnectedId(@RequestBody ConnectedIdRequest request) throws Exception {
    ...
    public ResponseEntity<String> addAccountOnConnectedId(@RequestBody ConnectedIdRequest request) throws Exception {
    ...
    public ResponseEntity<String> addAccountOnConnectedId() throws Exception {
